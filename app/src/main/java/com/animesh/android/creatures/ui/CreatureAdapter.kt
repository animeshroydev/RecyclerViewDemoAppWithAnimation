...
class CreatureAdapter(private val creatures: MutableList<Creature>, private val itemDragListener: ItemDragListener)
  : androidx.recyclerview.widget.RecyclerView.Adapter<CreatureAdapter.ViewHolder>(), ItemTouchHelperListener {
  ...
  inner class ViewHolder(itemView: View) : androidx.recyclerview.widget.RecyclerView.ViewHolder(itemView), View.OnClickListener, ItemSelectedListener {
